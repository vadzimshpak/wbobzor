...
INSERT INTO "new_feed_articles" ("coverImage", "coverImageAlt", "excerpt", "gridCol", "gridRow", "id", "publishedAt", "slug", "text", "title") SELECT "coverImage", "coverImageAlt", "excerpt", "gridCol", "gridRow", "id", "publishedAt", "slug", "text", "title" FROM "feed_articles";
